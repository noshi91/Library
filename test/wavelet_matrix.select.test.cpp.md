...
data:
  ...
  bundledCode: "#line 1 \"test/wavelet_matrix.select.test.cpp\"\n#define PROBLEM \
    \                                                               \\\n  \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
  ...
  verifiedWith: []
documentation_of: test/wavelet_matrix.select.test.cpp
layout: document
redirect_from:
- /verify/test/wavelet_matrix.select.test.cpp
- /verify/test/wavelet_matrix.select.test.cpp.html
